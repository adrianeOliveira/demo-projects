...
public class Key extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4637596159537993319L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Key\",\"namespace\":\"com.example.kafka.avro\",\"fields\":[{\"name\":\"key\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Random key value\"}]}");
   ...
   */
  public static com.example.kafka.avro.Key.Builder newBuilder() {
    return new com.example.kafka.avro.Key.Builder();
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static com.example.kafka.avro.Key.Builder newBuilder(com.example.kafka.avro.Key.Builder other) {
    if (other == null) {
      return new com.example.kafka.avro.Key.Builder();
    } else {
      return new com.example.kafka.avro.Key.Builder(other);
    }
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static com.example.kafka.avro.Key.Builder newBuilder(com.example.kafka.avro.Key other) {
    if (other == null) {
      return new com.example.kafka.avro.Key.Builder();
    } else {
      return new com.example.kafka.avro.Key.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Key>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafka.avro.Key.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafka.avro.Key other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.key)) {
        this.key = data().deepCopy(fields()[0].schema(), other.key);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.avro.Key.Builder setKey(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.avro.Key.Builder clearKey() {
      key = null;
